...
public abstract class BaseScene extends SceneFragment {
    ...
    public void setWhiteStatusBar(boolean set) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            requireActivity().findViewById(R.id.status_bar_background).setBackgroundColor(set ? Color.TRANSPARENT : AttrResources.getAttrColor(requireContext(), R.attr.colorPrimaryDark));
        } else {
            requireActivity().findViewById(R.id.status_bar_background).setBackgroundColor(AttrResources.getAttrColor(requireContext(), R.attr.colorPrimaryDark));
        }
    }
