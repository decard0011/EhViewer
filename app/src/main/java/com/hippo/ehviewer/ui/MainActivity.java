...
public final class MainActivity extends StageActivity
    ...
    protected void onCreate2(@Nullable Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.fragment_container), (v, insets) -> {
            findViewById(R.id.status_bar_background).setMinimumHeight(insets.getSystemWindowInsetTop());
            ViewGroup.LayoutParams lp = findViewById(R.id.status_bar_background).getLayoutParams();
            lp.height = insets.getSystemWindowInsetTop();
            findViewById(R.id.fragment_container).setPadding(insets.getSystemWindowInsetLeft(), insets.getSystemWindowInsetTop(), insets.getSystemWindowInsetRight(), insets.getSystemWindowInsetBottom());
            DrawerLayout.LayoutParams layoutParams = (DrawerLayout.LayoutParams) mRightDrawer.getLayoutParams();
